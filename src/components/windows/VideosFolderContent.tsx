  ...
  return (
    <div className="flex flex-col h-full bg-[#1e1e20] text-zinc-300 font-sans rounded-b-lg overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-2.5 border-b border-white/5 bg-[#252528] shrink-0">
        ...
        <div className="items-center bg-black/20 border border-white/10 rounded-md px-3 py-1.5 w-48 shadow-inner hidden sm:flex">
      ...
      <div className="flex-1 overflow-y-auto p-6 flex content-start gap-2 flex-wrap bg-mac-dark">
        {files.map(file => (
          ...
          >
            <div className="w-16 h-16 bg-linear-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center border border-white/20 shadow-md group-hover:shadow-[0_8px_16px_rgba(0,0,0,0.4)] group-hover:-translate-y-1 transition-all relative overflow-hidden">
